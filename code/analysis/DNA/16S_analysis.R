...
#create a table of relative counts
...
conc <- c() # MAKE SURE IN SAME ORDER AS counts_tab COLUMNS
...
#Define a 4 color clolorblind palette
...
#For order
dim(temp_filt_major_taxa_proportions_tab_o_mc01) # 8 main rows (taxa)
dim(temp_filt_major_taxa_proportions_tab_o_gc02) # 16 main rows (taxa)
dim(temp_filt_major_taxa_proportions_tab_o_gc04) # 15 main rows (taxa)
dim(temp_filt_major_taxa_proportions_tab_o_gc06) # 20 main rows (taxa)
...
filt_major_taxa_proportions_tab_o
#For genus
...
filt_major_taxa_proportions_tab_o_mc01
filt_major_taxa_proportions_tab_o_gc02
filt_major_taxa_proportions_tab_o_gc04
filt_major_taxa_proportions_tab_o_gc06
...
# First, we will modify our sample names to match how they were
...
# We could also make a pie chart for each sample:
...
# Going with a standard 0.05 cutoff, this is significant too (0.07), and tells us that 
